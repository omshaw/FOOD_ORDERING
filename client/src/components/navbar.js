...
const Navbar=({comp})=>{
    ...
    return (
        <div>
            <ul className="navbar">
                <li style={{margin:'0px 30% 0px 7%', width:'4%'}}>{ auth&&JSON.parse(auth).role==1?<Link to="/admin"><img src={require('../img/download.jfif')} alt="..." style={{width:'82%',objectFit:'cover',borderRadius:'50%'}}/></Link>:<Link to="/"><img src={require('../img/download.jfif')} alt="..." style={{width:'82%',objectFit:'cover',borderRadius:'50%'}}/></Link>}</li>
